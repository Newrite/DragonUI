...
local CT = {
    ...
    coinbox           = BagsterAssets .. 'commoncoinbox',
    currencybox       = BagsterAssets .. 'commoncurrencybox',
    coinGold          = BagsterAssets .. 'coingold',
    coinSilver        = BagsterAssets .. 'coinsilver',
    coinCopper        = BagsterAssets .. 'coincopper',
}

local function BagsterApplyPillChrome(frame, texturePath)
...
mod.CT = CT
mod.BagsterApplyPillChrome = BagsterApplyPillChrome
mod.L = L
mod.DB = DB
