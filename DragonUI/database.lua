    ...
    profile = {
        ...
        modules = {
            ...
            nameplates = {
                ...
                headlineShowHealthNumber = false, -- show current HP text while the health bar remains hidden
                headlineShowHealthPercent = false, -- show health percent while the health bar remains hidden
                headlineShowCastBar = false, -- allow DragonUI cast bars in headline mode
                ...
                personalResourceOffsetX = 0, -- PRD horizontal offset from its native anchor
                personalResourceOffsetY = 0, -- PRD vertical offset from its native anchor
                personalResourceFixedPosition = false, -- detach PRD visuals from the camera-driven native plate
                personalResourceFixedX = 0, -- fixed PRD position relative to screen center
                personalResourceFixedY = -160, -- fixed PRD position relative to screen center
                ...
                personalResourceHeight = 0, -- horizontal height; 0 inherits nameplate height
                personalResourceOrientation = "horizontal", -- horizontal | vertical
                personalResourceVerticalWidth = 14, -- width of each bar in vertical mode
                personalResourceVerticalHeight = 120, -- height of each bar in vertical mode
                personalResourceVerticalGap = 4, -- gap between health and power in vertical mode
                personalResourceVerticalHealthSide = "left", -- left | right
                personalResourceHealthText = "current_max", -- none | current | percent | current_max | current_percent
                personalResourcePowerText = "current_max", -- none | current | percent | current_max | current_percent
                personalResourceShowAbsorb = true, -- show the player's absorb shield over the PRD health bar
