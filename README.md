...
- Added a shared aura engine for attached player, target, focus, pet, party, boss, arena, ToT, and ToF icons, with per-family filtering, ownership desaturation, sorting, duration/spell lists, anchor/layout controls, a separately filtered Blizzard minimap aura frame, and movable player/target/focus aura bars with configurable media, backgrounds, borders, fonts, and optional LibSharedMedia integration.
