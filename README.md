...
- Isolated Personal Resource Display from regular nameplate behavior so it shows only DragonUI health and resource bars, with native-following or camera-independent screen positioning plus independent visibility, scale, dimensions, horizontal/vertical layout, value-format, and absorb-shield controls.
