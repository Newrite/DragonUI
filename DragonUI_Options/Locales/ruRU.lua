...
L["Show a simulated absorb shield for 5 seconds and report the all-source amount tracked by AbsorbsMonitor."] = "Показать тестовый щит на 5 секунд и вывести суммарное значение из всех источников, отслеживаемых AbsorbsMonitor."
L["AbsorbsMonitor tracked absorb: %s. Showing a simulated shield for 5 seconds."] = "AbsorbsMonitor отслеживает поглощение: %s. Тестовый щит показан на 5 секунд."
