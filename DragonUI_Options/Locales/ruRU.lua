...
L["Arena"] = "Арена"
L["Attach independently filtered aura icons to DragonUI unit frames. Player, target, focus, pet, party, boss, arena, and target-of-target families share the same renderer but keep separate settings."] = "Прикрепляет независимо фильтруемые значки аур к юнит-фреймам DragonUI. Игрок, цель, фокус, питомец, группа, боссы, арена и дополнительные цели используют общий рендерер, но отдельные настройки."
L["Attach To Unit Frame"] = "Якорь на юнит-фрейме"
L["Attached Aura Scale"] = "Масштаб прикреплённых аур"
L["Attached icon groups always follow their unit frame; configure their anchor and offsets here instead of moving them in Editor Mode."] = "Прикреплённые группы значков всегда следуют за юнит-фреймом; настройте их якорь и смещения здесь, а не в режиме редактора."
L["Attached Icon Layout"] = "Расположение прикреплённых значков"
L["Aura Duration Font Size"] = "Размер шрифта длительности аур"
L["Aura Icon X Offset"] = "Смещение значков аур по X"
L["Aura Icon Y Offset"] = "Смещение значков аур по Y"
L["Blizzard Aura Frame"] = "Панель аур Blizzard"
L["Boss"] = "Босс"
L["Configure Aura Icons For"] = "Настроить значки аур для"
L["Enable Attached Aura Icons"] = "Включить прикреплённые значки аур"
L["Filter and sort the standalone Blizzard buff/debuff frame without changing attached player-frame auras."] = "Фильтрует и сортирует отдельную панель бафов и дебафов Blizzard, не изменяя ауры на фрейме игрока."
L["Filter Blizzard Aura Frame"] = "Фильтровать панель аур Blizzard"
L["Horizontal Growth Direction"] = "Горизонтальное направление роста"
L["Horizontal Icon Spacing"] = "Горизонтальный интервал значков"
L["Icons Per Row"] = "Значков в строке"
L["Reset Selected Aura Icon Settings"] = "Сбросить настройки выбранных значков аур"
L["Show Aura Duration Text"] = "Показывать длительность аур"
L["Show Cooldown Swipe"] = "Показывать затемнение восстановления"
L["Show a filtered aura icon group anchored directly to this unit frame."] = "Показывает группу отфильтрованных значков аур, привязанную непосредственно к этому юнит-фрейму."
L["The Blizzard aura frame by the minimap is configured separately, so persistent buffs can remain there while timed combat auras are shown on the player frame."] = "Панель аур Blizzard у миникарты настраивается отдельно: постоянные бафы можно оставить там, а временные боевые ауры показывать на фрейме игрока."
L["Unit-Frame Aura Icons"] = "Значки аур юнит-фреймов"
L["Vertical Growth Direction"] = "Вертикальное направление роста"
L["Vertical Icon Spacing"] = "Вертикальный интервал значков"
L["All Casters"] = "Все источники"
L["Allow auras without a finite duration to pass this display's filters."] = "Разрешить отображение постоянных аур без конечной длительности."
L["Aura Bar Appearance"] = "Внешний вид полос аур"
L["Aura Bar Background Color"] = "Цвет фона полос аур"
L["Aura Bar Background Texture"] = "Текстура фона полос аур"
L["Aura Bar Border Color"] = "Цвет рамки полос аур"
L["Aura Bar Border Inset"] = "Отступ рамки полос аур"
L["Aura Bar Border Size"] = "Толщина рамки полос аур"
L["Aura Bar Border Texture"] = "Текстура рамки полос аур"
L["Aura Bar Font"] = "Шрифт полос аур"
L["Aura Bar Font Size"] = "Размер шрифта полос аур"
L["Aura Bar Growth Direction"] = "Направление роста полос"
L["Aura Bar Height"] = "Высота полосы ауры"
L["Aura Bar Icon Border Color"] = "Цвет рамки значка ауры"
L["Aura Bar Icon Border Coloring"] = "Окраска рамки значка ауры"
L["Aura Bar Icon Border Inset"] = "Отступ рамки значка ауры"
L["Aura Bar Icon Border Size"] = "Толщина рамки значка ауры"
L["Aura Bar Icon Border Texture"] = "Текстура рамки значка ауры"
L["Aura Bar Icon Side"] = "Сторона значка полосы"
L["Aura Bar Media and Borders"] = "Текстуры и рамки полос аур"
L["Aura Bar Scale"] = "Масштаб полос аур"
L["Aura Bar Spacing"] = "Расстояние между полосами"
L["Aura Bar Text and Icon Border"] = "Текст и рамка значка"
L["Aura Bar Text Color"] = "Цвет текста полос аур"
L["Aura Bar Text Outline"] = "Обводка текста полос аур"
L["Aura Bar Texture"] = "Текстура полос аур"
L["Aura Bar Width"] = "Ширина полосы ауры"
L["Aura Bars"] = "Полосы аур"
L["Aura Blacklist"] = "Чёрный список аур"
L["Aura Sort Method"] = "Сортировка аур"
L["Aura Whitelist"] = "Белый список аур"
L["Blizzard Order"] = "Порядок Blizzard"
L["Buff Bar Color"] = "Цвет полос бафов"
L["Cast by Me"] = "Наложенные мной"
L["Cast by Others"] = "Наложенные другими"
L["Caster Filter"] = "Фильтр по источнику"
L["Choose whether to show all auras, only auras applied by you, or only auras applied by others."] = "Показывать все ауры, только наложенные вами или только наложенные другими."
L["Color debuff bars by Magic, Curse, Disease, or Poison instead of the custom debuff color."] = "Окрашивать полосы дебафов по типу: магия, проклятие, болезнь или яд, вместо выбранного цвета."
L["Configure Aura Bars For"] = "Настроить полосы аур для"
L["Debuff Bar Color"] = "Цвет полос дебафов"
L["Desaturate Other Casters"] = "Обесцвечивать чужие ауры"
L["Down"] = "Вниз"
L["Enable Aura Bars"] = "Включить полосы аур"
L["Enter exact spell names or spell IDs separated by commas, semicolons, or new lines. Blacklist entries always win; a non-empty whitelist hides every aura not listed."] = "Введите точные названия или ID заклинаний через запятую, точку с запятой или с новой строки. Чёрный список имеет приоритет; непустой белый список скрывает все неуказанные ауры."
L["Hide timed auras whose total duration is longer than this value. Use 0 to disable this limit."] = "Скрывать временные ауры, полная длительность которых больше этого значения. 0 отключает ограничение."
L["Hide timed auras whose total duration is shorter than this value. Use 0 to disable this limit."] = "Скрывать временные ауры, полная длительность которых меньше этого значения. 0 отключает ограничение."
L["Include Permanent Auras"] = "Показывать постоянные ауры"
L["Keep other casters' auras in their original colors or render them desaturated."] = "Оставить оригинальные цвета чужих аур или показывать их обесцвеченными."
L["Latest Expiring First"] = "Истекающие позже первыми"
L["Longest Duration First"] = "Самые долгие первыми"
L["Maximum Aura Bars"] = "Максимум полос аур"
L["Maximum Aura Duration (Minutes)"] = "Максимальная длительность ауры (минуты)"
L["Maximum Buff Icons"] = "Максимум значков бафов"
L["Maximum Debuff Icons"] = "Максимум значков дебафов"
L["Mine First"] = "Сначала мои"
L["Media lists include DragonUI fallbacks and every compatible texture, border, or font currently registered in LibSharedMedia by addons such as Details and ElvUI."] = "Списки содержат встроенные варианты DragonUI и все совместимые текстуры, рамки и шрифты, зарегистрированные в LibSharedMedia аддонами вроде Details и ElvUI."
L["No Outline"] = "Без обводки"
L["Outline"] = "Обводка"
L["Minimum Aura Duration (Seconds)"] = "Минимальная длительность ауры (секунды)"
L["Move the selected bar group through Editor Mode. Aura bar filters and standard icon filters are completely independent."] = "Перемещайте выбранную группу полос в режиме редактирования. Фильтры полос и стандартных значков полностью независимы."
L["Name"] = "Название"
L["Original Colors"] = "Оригинальные цвета"
L["Other Casters' Auras"] = "Ауры других источников"
L["Other Casters' Tint"] = "Оттенок чужих аур"
L["Permanent Auras Last"] = "Постоянные ауры в конце"
L["Place auras without a duration after timed auras."] = "Размещать ауры без длительности после временных аур."
L["Reset Selected Aura Bars"] = "Сбросить выбранные полосы аур"
L["Shortest Duration First"] = "Самые короткие первыми"
L["Show Aura Bar Icons"] = "Показывать значки на полосах"
L["Same as Bar Texture"] = "Как текстура полосы"
L["Aura Color"] = "Цвет ауры"
L["Bar Border Color"] = "Цвет рамки полосы"
L["Thick Outline"] = "Толстая обводка"
L["Show auras as independently filtered horizontal status bars. Each player's, target's, and focus's bar group has its own Editor Mode mover and does not alter standard aura icons."] = "Показывает ауры в виде независимо фильтруемых горизонтальных полос. Группы игрока, цели и фокуса имеют отдельные рамки перемещения и не изменяют стандартные значки аур."
L["Show Buffs"] = "Показывать бафы"
L["Soonest Expiring First"] = "Истекающие раньше первыми"
L["Sorting and Duration"] = "Сортировка и длительность"
L["Spell Filters"] = "Фильтры заклинаний"
L["These controls style Blizzard target/focus aura buttons. When attached filtered icons are enabled below, their own layout and duration settings take over for that unit."] = "Эти настройки изменяют штатные кнопки аур цели и фокуса. Если ниже включены прикреплённые фильтруемые значки, для выбранного юнита используются их собственные настройки расположения и длительности."
L["Tint used for desaturated auras applied by other casters."] = "Оттенок для обесцвеченных аур, наложенных другими."
L["Up"] = "Вверх"
L["Use Dispel-Type Debuff Colors"] = "Цвета дебафов по типу рассеивания"
L["Visibility and Ownership"] = "Видимость и источник"
...
L["Show modern borders around buff and debuff icons."] = "Показывать современные рамки вокруг значков баффов и дебаффов."
L["Buff Border Color"] = "Цвет рамки баффов"
L["Reset Debuff Position"] = "Сбросить позицию дебаффов"
L["Debuff position reset."] = "Позиция дебаффов сброшена."
L["Debuffs detached - positioned freely via Editor Mode"] = "Дебаффы отделены и свободно перемещаются в режиме редактора"
L["Debuffs attached - follow buff row"] = "Дебаффы прикреплены и следуют за рядом баффов"
...
L["Use General Settings"] = "Использовать общие настройки"
L["Player Health Text"] = "Текст здоровья игроков"
L["Choose the health text format used only on player nameplates."] = "Выберите формат текста здоровья только для неймплейтов игроков."
L["Show Absorb on Friendly Nameplates"] = "Показывать поглощение на неймплейтах союзников"
L["Show all-source absorb shields on friendly nameplate health bars when the full plate is visible."] = "Показывать поглощение из всех источников на полосах здоровья дружественных неймплейтов, когда виден полный неймплейт."
L["Show Absorb on Enemy Nameplates"] = "Показывать поглощение на неймплейтах врагов"
L["Show all-source absorb shields on enemy nameplate health bars when the full plate is visible."] = "Показывать поглощение из всех источников на полосах здоровья вражеских неймплейтов, когда виден полный неймплейт."
...
L["Show absorb effects on the player from any tracked source over the personal health bar."] = "Показывать поверх персональной полосы здоровья эффекты поглощения на игроке из любого отслеживаемого источника."
L["Personal Resource Class Color"] = "Цвет класса для PRD"
L["Use the player's class color only for the personal resource health bar."] = "Использовать цвет класса игрока только для персональной полосы здоровья."
L["Personal Resource Health Color"] = "Цвет здоровья PRD"
L["Choose the personal resource health color used when class color is disabled."] = "Выберите цвет персональной полосы здоровья, используемый при выключенном цвете класса."
L["Personal Resource Orientation"] = "Ориентация персонального ресурса"
L["Arrange personal health and power as horizontal bars or vertical bars side by side."] = "Расположить полосы здоровья и ресурса горизонтально или вертикально рядом друг с другом."
L["Personal Resource Vertical Width"] = "Ширина вертикальной полосы"
L["Personal Resource Vertical Height"] = "Высота вертикальной полосы"
L["Personal Resource Vertical Gap"] = "Зазор между вертикальными полосами"
L["Test Personal Resource Absorb"] = "Проверить поглощение персонального ресурса"
L["Show a simulated absorb shield for 5 seconds and report the currently tracked all-source amount."] = "Показать тестовый щит на 5 секунд и вывести текущее суммарное значение поглощения из всех источников."
L["Tracked player absorb: %s. Showing a simulated shield for 5 seconds."] = "Отслеживаемое поглощение игрока: %s. Тестовый щит показан на 5 секунд."
L["Show Personal Resource Health Bar"] = "Показывать полосу здоровья PRD"
L["Show Personal Resource Power Bar"] = "Показывать полосу ресурса PRD"
L["Personal Resource Scale"] = "Масштаб PRD"
L["Personal Resource Width"] = "Ширина PRD"
L["Horizontal bar width. Set to 0 to inherit the regular nameplate width."] = "Ширина горизонтальных полос. Значение 0 наследует ширину обычных неймплейтов."
L["Personal Resource Height"] = "Высота PRD"
L["Horizontal bar height. Set to 0 to inherit the regular nameplate height."] = "Высота горизонтальных полос. Значение 0 наследует высоту обычных неймплейтов."
L["Personal Resource Horizontal Width"] = "Ширина горизонтального PRD"
L["Personal Resource Horizontal Height"] = "Высота горизонтального PRD"
L["Personal Resource Vertical Order"] = "Порядок вертикальных полос"
L["Health Left, Power Right"] = "Здоровье слева, ресурс справа"
...
L["Personal Resource X Offset"] = "Смещение личного ресурса по X"
L["Personal Resource Y Offset"] = "Смещение личного ресурса по Y"
L["Position of DragonUI health and resource bars relative to the native personal resource anchor."] = "Положение полос здоровья и ресурса DragonUI относительно стандартной точки привязки личного ресурса."
