...
L["Show a simulated absorb shield for 5 seconds and report the all-source amount tracked by AbsorbsMonitor."] = true
L["AbsorbsMonitor tracked absorb: %s. Showing a simulated shield for 5 seconds."] = true
