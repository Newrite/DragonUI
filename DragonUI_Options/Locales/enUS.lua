...
-- Unit-frame aura filtering and aura bars
L["Arena"] = true
L["All Casters"] = true
L["Allow auras without a finite duration to pass this display's filters."] = true
L["Attach independently filtered aura icons to DragonUI unit frames. Player, target, focus, pet, party, boss, arena, and target-of-target families share the same renderer but keep separate settings."] = true
L["Attach To Unit Frame"] = true
L["Attached Aura Scale"] = true
L["Attached icon groups always follow their unit frame; configure their anchor and offsets here instead of moving them in Editor Mode."] = true
L["Attached Icon Layout"] = true
L["Aura Bar Appearance"] = true
L["Aura Bar Background Color"] = true
L["Aura Bar Background Texture"] = true
L["Aura Bar Border Color"] = true
L["Aura Bar Border Inset"] = true
L["Aura Bar Border Size"] = true
L["Aura Bar Border Texture"] = true
L["Aura Bar Font"] = true
L["Aura Bar Font Size"] = true
L["Aura Bar Growth Direction"] = true
L["Aura Bar Height"] = true
L["Aura Bar Icon Border Color"] = true
L["Aura Bar Icon Border Coloring"] = true
L["Aura Bar Icon Border Inset"] = true
L["Aura Bar Icon Border Size"] = true
L["Aura Bar Icon Border Texture"] = true
L["Aura Bar Icon Side"] = true
L["Aura Bar Media and Borders"] = true
L["Aura Bar Scale"] = true
L["Aura Bar Spacing"] = true
L["Aura Bar Text and Icon Border"] = true
L["Aura Bar Text Color"] = true
L["Aura Bar Text Outline"] = true
L["Aura Bar Texture"] = true
L["Aura Bar Width"] = true
L["Aura Bars"] = true
L["Aura Blacklist"] = true
L["Aura Sort Method"] = true
L["Aura Whitelist"] = true
L["Aura Duration Font Size"] = true
L["Aura Icon X Offset"] = true
L["Aura Icon Y Offset"] = true
L["Blizzard Aura Frame"] = true
L["Blizzard Order"] = true
L["Buff Bar Color"] = true
L["Cast by Me"] = true
L["Cast by Others"] = true
L["Caster Filter"] = true
L["Choose whether to show all auras, only auras applied by you, or only auras applied by others."] = true
L["Color debuff bars by Magic, Curse, Disease, or Poison instead of the custom debuff color."] = true
L["Configure Aura Bars For"] = true
L["Configure Aura Icons For"] = true
L["Debuff Bar Color"] = true
L["Desaturate Other Casters"] = true
L["Down"] = true
L["Enable Aura Bars"] = true
L["Enable Attached Aura Icons"] = true
L["Enter exact spell names or spell IDs separated by commas, semicolons, or new lines. Blacklist entries always win; a non-empty whitelist hides every aura not listed."] = true
L["Filter and sort the standalone Blizzard buff/debuff frame without changing attached player-frame auras."] = true
L["Filter Blizzard Aura Frame"] = true
L["Hide timed auras whose total duration is longer than this value. Use 0 to disable this limit."] = true
L["Hide timed auras whose total duration is shorter than this value. Use 0 to disable this limit."] = true
L["Include Permanent Auras"] = true
L["Icons Per Row"] = true
L["Horizontal Growth Direction"] = true
L["Horizontal Icon Spacing"] = true
L["Keep other casters' auras in their original colors or render them desaturated."] = true
L["Latest Expiring First"] = true
L["Longest Duration First"] = true
L["Maximum Aura Bars"] = true
L["Maximum Aura Duration (Minutes)"] = true
L["Maximum Buff Icons"] = true
L["Maximum Debuff Icons"] = true
L["Mine First"] = true
L["Media lists include DragonUI fallbacks and every compatible texture, border, or font currently registered in LibSharedMedia by addons such as Details and ElvUI."] = true
L["No Outline"] = true
L["Outline"] = true
L["Minimum Aura Duration (Seconds)"] = true
L["Move the selected bar group through Editor Mode. Aura bar filters and standard icon filters are completely independent."] = true
L["Name"] = true
L["Original Colors"] = true
L["Other Casters' Auras"] = true
L["Other Casters' Tint"] = true
L["Permanent Auras Last"] = true
L["Place auras without a duration after timed auras."] = true
L["Reset Selected Aura Bars"] = true
L["Reset Selected Aura Icon Settings"] = true
L["Shortest Duration First"] = true
L["Show Aura Bar Icons"] = true
L["Same as Bar Texture"] = true
L["Aura Color"] = true
L["Bar Border Color"] = true
L["Thick Outline"] = true
L["Show Aura Duration Text"] = true
L["Show Cooldown Swipe"] = true
L["Show a filtered aura icon group anchored directly to this unit frame."] = true
L["Show auras as independently filtered horizontal status bars. Each player's, target's, and focus's bar group has its own Editor Mode mover and does not alter standard aura icons."] = true
L["Show Buffs"] = true
L["Soonest Expiring First"] = true
L["Sorting and Duration"] = true
L["Spell Filters"] = true
L["These controls style Blizzard target/focus aura buttons. When attached filtered icons are enabled below, their own layout and duration settings take over for that unit."] = true
L["The Blizzard aura frame by the minimap is configured separately, so persistent buffs can remain there while timed combat auras are shown on the player frame."] = true
L["Tint used for desaturated auras applied by other casters."] = true
L["Up"] = true
L["Use Dispel-Type Debuff Colors"] = true
L["Unit-Frame Aura Icons"] = true
L["Vertical Growth Direction"] = true
L["Vertical Icon Spacing"] = true
L["Visibility and Ownership"] = true
...
L["Current / Max"] = true
L["Use General Settings"] = true
L["Player Health Text"] = true
L["Choose the health text format used only on player nameplates."] = true
L["Show Absorb on Friendly Nameplates"] = true
L["Show all-source absorb shields on friendly nameplate health bars when the full plate is visible."] = true
L["Show Absorb on Enemy Nameplates"] = true
L["Show all-source absorb shields on enemy nameplate health bars when the full plate is visible."] = true
...
L["Show absorb effects on the player from any tracked source over the personal health bar."] = true
L["Personal Resource Class Color"] = true
L["Use the player's class color only for the personal resource health bar."] = true
L["Personal Resource Health Color"] = true
L["Choose the personal resource health color used when class color is disabled."] = true
L["Personal Resource Orientation"] = true
L["Arrange personal health and power as horizontal bars or vertical bars side by side."] = true
L["Personal Resource Vertical Width"] = true
L["Personal Resource Vertical Height"] = true
L["Personal Resource Vertical Gap"] = true
L["Test Personal Resource Absorb"] = true
L["Show a simulated absorb shield for 5 seconds and report the currently tracked all-source amount."] = true
L["Tracked player absorb: %s. Showing a simulated shield for 5 seconds."] = true
L["Show Personal Resource Health Bar"] = true
L["Show Personal Resource Power Bar"] = true
L["Personal Resource Scale"] = true
L["Personal Resource Width"] = true
...
L["Personal Resource X Offset"] = true
L["Personal Resource Y Offset"] = true
L["Position of DragonUI health and resource bars relative to the native personal resource anchor."] = true
